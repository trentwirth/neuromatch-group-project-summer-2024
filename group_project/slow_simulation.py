...
if DEBUG:
    ...
    ax1.set_title("Connectivity Matrix", fontsize=20)
    ax1.set_xlabel("Neuron Number", fontsize=16)
...
def process_row(index, row):
    ...
    return percept_decision, simulation_error

# Loop through rows
for index, row in subject_filtered_data.iterrows():
    percept_decision, simulation_error = process_row(index, row)
